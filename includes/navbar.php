...
';
    ...
    <div class="collapse navbar-collapse mr-4" id="navbar">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            <li>
                <a class="nav-link username-nav"
                    href="profile.php?u_id=' . $userId . '">' . $userFname . ' ' . $userLname . '</a>
</li>
...
<li class="nav-item dropdown d-flex align-item-center">
    <a class="nav-link dropdown-toggle" href="users.php" id="usersDropdown" data-toggle="dropdown" aria-haspopup="true"
        aria-expanded="false"><i class="fas fa-user-cog fa-lg  "></i></a>
    <div class="dropdown-menu" aria-labelledby="usersDropdown">
        <a class="dropdown-item" href="#">Settings</a>
        <a class="dropdown-item" href="includes/logout.php">logout</a>
    </div>
